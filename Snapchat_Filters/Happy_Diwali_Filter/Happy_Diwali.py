...
def main():
    ...
    while True:
        ...
        if getFrame:
            ...
            img = cv2.imread('hampy_diwali.jpg', -1)
            ...
            diwali = cv2.resize(mask_img, (wd, ht))
            ...
            frame2 = cv2.bitwise_and(diwali, diwali, mask=mask)
            ...
            cv2.resizeWindow('Snapchat Filter Diwali', 100, 200)
